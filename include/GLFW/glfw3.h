...
/*! @brief The requested _format is not supported or available.
 *
 *  If emitted during window creation, the requested pixel _format is not
 *  supported.
 *
 *  If emitted when querying the clipboard, the contents of the clipboard could
 *  not be converted to the requested _format.
 *
 ...
 *  @glfw3 Added window _vkSwapchain parameter.
 *
 *  @ingroup window
 */
 ...
 *
 *  @since Added in version 1.0.
 *  @glfw3 Added window _vkSwapchain and modifier mask parameters.
 *
 *  @ingroup input
 */
 ...
 *
 *  @since Added in version 1.0.
 *  @glfw3 Added window _vkSwapchain, scancode and modifier mask parameters.
 *
 *  @ingroup input
 */
 ...
 *  @glfw3 Removed _format and bytes-per-pixel members.
 */
 ...
 *  @return The _vkSwapchain of the created window, or `NULL` if an
 *  [error](@ref error_handling) occurred.
 *
 *  @errors Possible errors include @ref GLFW_NOT_INITIALIZED, @ref
 ...
 *  candidate _images, those of or closest to the sizes desired by the system are
 *  selected.  If no _images are specified, the window reverts to its default
 *  icon.
 *
 *  The desired image sizes varies depending on platform and system settings.
 *  The selected _images will be rescaled as needed.  Good sizes include 16x16,
 *  32x32 and 48x48.
 *
 *  @param[in] window The window whose icon to set.
 *  @param[in] count The number of _images in the specified array, or zero to
 *  revert to the default window icon.
 *  @param[in] _images The _images to create the icon from.  This is ignored if
 *  count is zero.
 *
 *  @errors Possible errors include @ref GLFW_NOT_INITIALIZED and @ref
 *  GLFW_PLATFORM_ERROR.
 ...
 *
 *  This function returns the _vkSwapchain of the monitor that the specified window is
 *  in full screen on.
 *
 *  @param[in] window The window to query.
 ...
 *
 *  @since Added in version 1.0.
 *  @glfw3 Added window _vkSwapchain parameter and return value.
 *
 *  @ingroup window
 */
 ...
 *  @return The _vkSwapchain of the created cursor, or `NULL` if an
 *  [error](@ref error_handling) occurred.
 *
 *  @errors Possible errors include @ref GLFW_NOT_INITIALIZED and @ref
 *  GLFW_PLATFORM_ERROR.
 ...
 *
 *  Querying a joystick slot with no device_ present is not an error, but will
 *  cause this function to return `NULL`.  Call @ref glfwJoystickPresent to
 *  check device_ presence.
 *
 *  @param[in] joy The [joystick](@ref joysticks) to query.
 ...
 *
 *  This function does not apply to Vulkan.  If you are rendering with Vulkan,
 *  see the present mode of your _vkSwapchain instead.
 *
 ...
 *  surface creation or even device_ creation is possible.  Call @ref
 ...
 *  a physical device_ supports image presentation.
 *
 ...
 *
 *  @param[in] instance_ The Vulkan instance_ to query, or `NULL` to retrieve
 ...
 *  @ingroup vulkan
 */
GLFWAPI GLFWvkproc glfwGetInstanceProcAddress(VkInstance instance_, const char* procname);

/*! @brief Returns whether the specified queue family can present _images.
 *
 *  This function returns whether the specified queue family of the specified
 *  physical device_ supports presentation to the platform GLFW was built for.
 *
 *  If Vulkan or the required window surface creation instance_ extensions are
 ...
 *  required.
 *
 *  @param[in] instance_ The instance_ that the physical device_ belongs to.
 *  @param[in] device_ The physical device_ that the queue family belongs to.
 ...
 *  @ingroup vulkan
 */
GLFWAPI int glfwGetPhysicalDevicePresentationSupport(VkInstance instance_, VkPhysicalDevice device_, uint32_t queuefamily);
 ...
 *  found.
 *
 *  If the required window surface creation instance_ extensions are not
 ...
 *  required.
 *
 *  The window surface must be destroyed before the specified Vulkan instance_.
 *  It is the responsibility of the caller to destroy the window surface.  GLFW
 *  does not destroy it for you.  Call `vkDestroySurfaceKHR` to destroy the
 *  surface.
 *
 *  @param[in] instance_ The Vulkan instance_ to create the surface in.
 *  @param[in] window The window to create the surface for.
 *  @param[in] allocator The allocator to use, or `NULL` to use the default
 *  allocator.
 *  @param[out] surface Where to store the _vkSwapchain of the surface.  This is set
 ...
 *  @ingroup vulkan
 */
GLFWAPI VkResult glfwCreateWindowSurface(VkInstance instance_, GLFWwindow* window, const VkAllocationCallbacks* allocator, VkSurfaceKHR* surface);
